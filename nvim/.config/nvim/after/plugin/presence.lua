...
--     neovim_image_text   = "The based editor", -- Text displayed when hovered over the Neovim image
...
-- })
--
-- local presenceEnabled = false; -- defualt value
...
--
-- -- Key binds
-- vim.keymap.set("n", "<leader>die", function() PresenceEnable() end);
-- vim.keymap.set("n", "<leader>did", function() PresenceDisable() end);
-- vim.keymap.set("n", "<leader>dit", function() PresenceToggle() end);
